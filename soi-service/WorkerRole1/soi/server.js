var Server = IgeClass.extend({
    ...
    self.players = {};
    // Define an object to hold references to our party entities
    self.parties = {};
    // Define an object to hold references to our instance entities
    self.instances = {};
    ...
    self.implement(ServerNetworkEvents);
		...
		ige.addComponent(IgeNetIoComponent).network.start(8000, function () {
