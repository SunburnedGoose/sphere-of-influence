app.factory('soiCelestialBodyService', function() {
  var celestialBodies = {
    "sun": null,
    "planets": [],
    "derelics": [],
  ...
  alpha = new CelestialBody('721045 SA2048');
  alpha.id = 'alpha';
  alpha.mass = 2.14e21;
  alpha.radius = 555;
  alpha.sma = 7.17e9;
  ...
  beta = new CelestialBody('110607 Hayden');
  beta.id = 'beta';
  beta.mass = 5.67e21;
  beta.radius = 863;
  beta.sma = 6.5e9;
  ...
  gamma = new CelestialBody('1982857 Goos');
  gamma.id = 'gamma';
  gamma.mass = 3.19e21;
  gamma.radius = 715;
  gamma.sma = 6.85e9;
  gamma.coordinates = ['30%', '0%'];
  gamma.axialTilt = 30;
